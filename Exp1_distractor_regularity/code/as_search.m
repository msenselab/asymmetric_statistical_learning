...
%        v.flip(1);
  ...
  v.dispText(['Did you notice any pattern to how the position of the distractor changed\n', ...
  ...
  v.dispText(['Which of the following changes of distractor position from one trial to\n', ...
