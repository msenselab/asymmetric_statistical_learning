...
try
    ...
    exp = CExp(1,[8, 2, 2, 30],'blockRepetition',1); 
    N=size(exp.seq,1);   
    ...
    absent_motion = ceil(n/2)-1; % Determines whehter the distracot pos. moves on target absent trials
    ...
    for i=1:exp.maxTrls
        ...
        elseif exp.seq(i,4) <= 23 %% 23 = 10 + 0.65*20
