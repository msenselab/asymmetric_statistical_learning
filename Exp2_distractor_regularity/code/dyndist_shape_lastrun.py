...
expName = 'dyndist'  # from the Builder filename that created this script
expInfo = {'participant': '', 'group': '', 'age': '', 'sex': ''}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/haileyyu/Desktop/新文件夹/project 1/distractor search/shape singleton/program/dyndist_shape_lastrun.py',
...
trials = data.TrialHandler(nReps=1, method='sequential', 
    ...
    trialList=data.importConditions("sequences_ori/seq_"+expInfo['group']+".csv"),
...
for thisTrial in trials:
    ...
    key_resp.rt = []
    _key_resp_allKeys = []
    fixcross_search.setSize((0.5/ScreenHeight, 0.5/ScreenHeight))
    # keep track of which components have finished
